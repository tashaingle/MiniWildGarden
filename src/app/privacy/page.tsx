...
export default function PrivacyPage() {
  return (
    <main className="legal-page"><div className="shell legal-page__inner">
      ...
      <section><h2>Who is responsible for the site</h2><p>Mini Wild Garden is operated by Natasha Card. Privacy questions can be sent to <a href="mailto:hello@miniwildgarden.co.uk">hello@miniwildgarden.co.uk</a>.</p></section>
